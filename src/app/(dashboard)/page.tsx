    ...
    <div className="space-y-8">
      <div className="animate-fade-up">
        ...
        <p className="text-sm mt-1" style={{ color: "oklch(0.520 0.015 60)" }}>
          Acompanhe os indicadores da clinica
        </p>
      </div>
        ...
        <div className="card-elevated animate-fade-up delay-300 rounded-xl overflow-hidden">
          ...
          {recalls.length === 0 ? (
            <div className="px-6 py-10 text-center">
              <p className="text-sm" style={{ color: "oklch(0.520 0.015 60)" }}>Nenhum recall nos proximos 7 dias.</p>
            </div>
          ) : (
          ...
          <div className="px-6 py-10 text-center">
            <p className="text-sm" style={{ color: "oklch(0.520 0.015 60)" }}>
              {summary?.messages_sent_this_month
                ? `${summary.messages_sent_this_month} mensagem(ns) enviada(s) este mes.`
                : "Nenhuma mensagem enviada ainda."}
            </p>
            <p className="text-xs mt-2" style={{ color: "oklch(0.700 0.010 60)" }}>
              Acesse o historico completo em Mensagens.
            </p>
          </div>
        </div>
      </div>
